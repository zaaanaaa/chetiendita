        ...
        {step === "form" ? (
          <>
              ...
              <div className="checkout-items-list">
                {items.map((item) => (
                  <div key={`${item.productId}-${item.variant}`} className="checkout-item-row">
                    ...
                    <span className="checkout-item-price">{formatCurrency(item.unitPrice * item.quantity)}</span>
                  </div>
                ))}
              </div>
            ...
            <form className="checkout-form" onSubmit={handleSubmit}>
              ...
              <button className="checkout-submit-btn" type="submit" disabled={isPending}>
          ...
          <div className="checkout-success">
            ...
            <a
              ...
              href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hola! Acabo de hacer un pedido en Che Tiendita a nombre de ${customerName}. Me gustaría coordinar el pago.`)}`}
              target="_blank"
            ...
            >
              ...
              Arreglar pago por WhatsApp
            </a>
            <p className="whatsapp-number-text">
              O escribinos directamente al <strong>+54 9 11 1234-5678</strong>
            </p>
